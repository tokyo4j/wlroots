...
static uint32_t pointer_position(struct wlr_input_filter_pointer *pointer,
	...
	struct wlr_relative_pointer_v1_input_filter_layer *layer =
...
static const struct wlr_input_filter_pointer_impl pointer_impl = {
	.base = {
		.name = "wlr_relative_pointer_v1_input_filter_layer-pointer",
	},
...
static void handle_router_destroy(struct wl_listener *listener, void *data) {
	...
	wlr_relative_pointer_v1_input_filter_layer_destroy(layer);
}
...
bool wlr_relative_pointer_v1_input_filter_layer_register(int32_t priority) {
...
struct wlr_relative_pointer_v1_input_filter_layer *
wlr_relative_pointer_v1_input_filter_layer_create(
		struct wlr_input_filter *filter, struct wlr_relative_pointer_manager_v1 *manager,
		struct wlr_seat *seat) {
	struct wlr_relative_pointer_v1_input_filter_layer *layer = calloc(1, sizeof(*layer));
	if (layer == NULL) {
...
void wlr_relative_pointer_v1_input_filter_layer_destroy(
		struct wlr_relative_pointer_v1_input_filter_layer *layer) {
	if (layer == NULL) {
		return;
	}
